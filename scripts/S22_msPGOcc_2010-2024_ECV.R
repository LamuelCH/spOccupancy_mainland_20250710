...
# Enhanced Version with Configurable Environmental Clustering K-Fold Cross-Validation
# =============================================================================
...
tryCatch({
  ...
  cat("*** ", K_FOLDS, "-FOLD ENVIRONMENTAL CLUSTERING CROSS-VALIDATION CONFIGURED ***\n\n", sep = "")
  ...
  cat("Scaling coordinates to kilometers for environmental clustering...\n")
  ...
  # STEP 5: ENVIRONMENTAL CLUSTERING CROSS-VALIDATION SETUP ==================
  cat("\n=== STEP 5: ENVIRONMENTAL CLUSTERING CROSS-VALIDATION SETUP ===\n")
  ...
  # Create spatial blocks using environmental clustering
  cat("\nCreating spatial blocks using environmental clustering...\n")
  cat("  Method: cv_cluster (environmental clustering)\n")
  ...
  cat("\n=== STEP 9: ENVIRONMENTAL CLUSTERING CROSS-VALIDATION MODEL FITTING ===\n")
  ...
  cat("  - Fold assignment: Environmental clustering (spatial blocks)\n")
  ...
  # Fit the non-spatial multi-species model with environmental clustering CV
  cat("\n--- NON-SPATIAL", K_FOLDS, "FOLD ENVIRONMENTAL CLUSTERING CV MODEL FITTING IN PROGRESS ---\n")
  ...
  model_result <- tryCatch({
    msPGOcc(
      ...
      k.fold.seed = 123,
      k.fold.only = TRUE,
      custom.cluster = sb$folds_ids  # Environmental clustering fold assignments
    )
  }, error = function(e) {
  ...
  cat("\n--- NON-SPATIAL", K_FOLDS, "FOLD ENVIRONMENTAL CLUSTERING CV MODEL FITTING COMPLETED ---\n")
  ...
  if(!is.null(model_result)) {
    ...
    cat("  - Cross-validation:", K_FOLDS, "fold Environmental Clustering\n")
    ...
    cat("\n NON-SPATIAL", K_FOLDS, "FOLD ENVIRONMENTAL CLUSTERING CV MODEL FITTING SUCCESSFUL!\n")

    
  } else {
    cat("Â  NON-SPATIAL", K_FOLDS, "FOLD ENVIRONMENTAL CLUSTERING CV MODEL FITTING FAILED\n")
...
if(exists("out.msPGOcc") && !is.null(out.msPGOcc)) {
  ...
  sink(diag_file)
  cat("=== ", K_FOLDS, " FOLD ENVIRONMENTAL CLUSTERING CV DIAGNOSTIC SUMMARY ===\n", sep = "")
  cat("Generated:", format(Sys.time()), "\n\n")
  
  cat("Model Configuration:\n")
  cat("  - Model type: msPGOcc (Non-Spatial)\n")
  cat("  - K-fold CV:", K_FOLDS, "folds\n")
  cat("  - CV Type: Environmental Clustering\n")
  ...
  cat("Environmental Clustering Details:\n")
...
cat("\n=== ", K_FOLDS, " FOLD ENVIRONMENTAL CLUSTERING CV SCRIPT EXECUTION COMPLETED ===\n", sep = "")
cat("Session info:\n")
print(sessionInfo())