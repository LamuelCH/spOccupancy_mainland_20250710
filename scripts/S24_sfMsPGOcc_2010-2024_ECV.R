...
tryCatch({
  ...
  cat("\n--- SPATIAL FACTOR", K_FOLDS, "FOLD ENVIRONMENTAL CLUSTERING CV MODEL FITTING IN PROGRESS ---\n")
  ...
  cat("\n--- SPATIAL FACTOR", K_FOLDS, "FOLD ENVIRONMENTAL CLUSTERING CV MODEL FITTING COMPLETED ---\n")
  ...
  if(!is.null(model_result)) {
    ...
    cat("\n SPATIAL FACTOR", K_FOLDS, "FOLD ENVIRONMENTAL CLUSTERING CV MODEL FITTING SUCCESSFUL!\n")
    
  } else {
    cat("Â  SPATIAL FACTOR", K_FOLDS, "FOLD ENVIRONMENTAL CLUSTERING CV MODEL FITTING FAILED\n")
