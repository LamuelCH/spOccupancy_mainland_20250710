...
tryCatch({
  ...
  # # STEP 5: Random CROSS-VALIDATION SETUP ============================
  # cat("\n=== STEP 5: Random CROSS-VALIDATION SETUP ===\n")
  # 
  ...
  # 
  # # Create Randoms using Random
  # cat("\nCreating Randoms using Random...\n")
  # cat("  Method: cv_cluster (Random)\n")
  ...
  # 
  # # Save CV plot
  # cat("\nGenerating Random visualization...\n")
  ...
  # dev.off()
  # 
  # cat(" Random plot saved to:", plot_file, "\n")
  ...
  cat("  - Fold assignment: Random (Randoms)\n")
  ...
  cat("\n--- SPATIAL FACTOR", K_FOLDS, "FOLD Random CV MODEL FITTING IN PROGRESS ---\n")
  ...
  cat("\n--- SPATIAL FACTOR", K_FOLDS, "FOLD Random CV MODEL FITTING COMPLETED ---\n")
  ...
  if(!is.null(model_result)) {
    ...
    cat("  - Cross-validation:", K_FOLDS, "fold Random\n")
    ...
    cat("\n SPATIAL FACTOR", K_FOLDS, "FOLD Random CV MODEL FITTING SUCCESSFUL!\n")
    
  } else {
    cat("Â  SPATIAL FACTOR", K_FOLDS, "FOLD Random CV MODEL FITTING FAILED\n")
