...
tryCatch({
  ...
  cat("    - Clustering method: K-means on spatial coordinate\n")
  ...
  cat("\n--- SPATIAL", K_FOLDS, "FOLD Spatial Blocking CV MODEL FITTING IN PROGRESS ---\n")
  ...
  cat("\n--- SPATIAL", K_FOLDS, "FOLD Spatial Blocking CV MODEL FITTING COMPLETED ---\n")
  ...
  if(!is.null(model_result)) {
    ...
    cat("\n SPATIAL", K_FOLDS, "FOLD Spatial Blocking CV MODEL FITTING SUCCESSFUL!\n")
    
    
  } else {
    cat("Â  SPATIAL", K_FOLDS, "FOLD Spatial Blocking CV MODEL FITTING FAILED\n")
